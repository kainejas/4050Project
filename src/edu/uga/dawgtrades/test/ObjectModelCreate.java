 ...
 public static void main(String[] args)
 {
     ...
     persistence.init();
      try {
    	  ...
    	  item1 = objectModel.createItem(category1, rUser1, "name1", "desc1");
    	  objectModel.storeItem(item1);
    	  
    	  item2 = objectModel.createItem(category2, rUser2, "name2", "desc2");
    	  objectModel.storeItem(item2);
    	  
    	  item3 = objectModel.createItem(category3, rUser3, "name3", "desc3");
    	  ...
    	  auction1 = objectModel.createAuction(item1, 12.50f, new Date("12/12/2015"));
    	  objectModel.storeAuction(auction1);
    	  
    	  auction2 = objectModel.createAuction(item2, 23.75f, new Date("12/12/2000"));
    	  objectModel.storeAuction(auction2);
    	  
    	  auction3 = objectModel.createAuction(item3, 34.88f, new Date("12/12/2014"));
    	  objectModel.storeAuction(auction3);
    	  
    	  bid1 = objectModel.createBid(auction1, rUser1, 13.33f);
    	  objectModel.storeBid(bid1);
    	  
    	  bid2 = objectModel.createBid(auction2, rUser2, 24.55f);
    	  objectModel.storeBid(bid2);
    	  
    	  bid3 = objectModel.createBid(auction3, rUser3, 35.23f);
